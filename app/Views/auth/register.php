...
<body class="text-center">
    <form class="form-signin" action="<? echo base_url('/auth/register') ?>" method="post">
        ...
        <div>
            ...
            <input type="text" id="inputName" class="form-control <? echo $validation->hasError('name') ? 'is-invalid' : '' ?>" name="name" placeholder="Name" autofocus>
        ...
        <div>
            ...
            <input type="email" id="inputEmail" class="form-control <? echo $validation->hasError('email') ? 'is-invalid' : '' ?>" name="email" placeholder="Email address">
            <div class="invalid-feedback">
